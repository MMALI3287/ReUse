            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    auth.signInWithEmailAndPassword(txt_email,txt_password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(SignupPage.this, "Succesful Login", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(SignupPage.this, "Something went wrong D", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
                else{
                    Toast.makeText(SignupPage.this, "The email address is already in use", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
